...
\subtext{Pune, Maharashtra, India {\normalsize\normalfont (On-site, full-time) }} 
    \begin{zitemize}
        \item Received training in Spring Boot, JUnit \& AWS
        \item Wrote 20+ unit testcases to verify exception response for various scenarios on certain module of project 
    \end{zitemize}
