...
\subsection*{Etherfunds {\normalsize\normalfont | (Blockchain based Crowdfunding platform) | Solidity, ReactJS | Ongoing} 
% \hfill {\href{https://github.com/DevelopersLeague/EverHustle-FrontEnd}{Code} } | {\href{https://everhustle.netlify.app/}{Demo} }
} 
    \begin{zitemize}
        % \item Crowdfunding platform based on ethereum blockchain
        \item Basic CRUD features are provided to add new Fundraisers
        \item To keep control over the funds, the creator has to gain at least 50\% vote for a withdrawal request to get approved
        \item Managing a group of 3, collaborating on building UI and writing smart contracts
    \end{zitemize}
...
HTML, CSS, Bootstrap, JavaScript, ReactJS, SQL, Django, C/C++, Solidity, Git, OOP in Java
