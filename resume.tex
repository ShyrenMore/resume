...
\begin{flushleft}
    ...
    \vspace{0.1cm}
    LinkedIn / \href{https://linkedin.com/in/shyrenmore/}{ shyrenmore} | Leetcode / \href{https://leetcode.com/shyren_more/}{shyren\textunderscore more}      \\
    \vspace{0.1cm}
...
\begin{zitemize}
        \item \textbf{4-star} on CodeChef: Max rating of 1901
        ...
        \item  \textbf{Institution rank 5} out of 180+ active participants on CodeChef  \href{
        https://www.codechef.com/ratings/all?filterBy=Institution\%3DThadomal\%20Shahani\%20Engineering\%20College&itemsPerPage=15&order=asc&page=1&sortBy=global_rank
        }{(\textit{view standings})}
