...
\begin{zitemize}
    ...
    \item Ranked \textbf{2/1000+} Geeks on GeeksForGeeks platform \href{https://auth.geeksforgeeks.org/college/thadomal-shahani-engineering-college-tsec-mumbai/}{(\textit{view standings}).}
