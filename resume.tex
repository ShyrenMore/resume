...
\hfill {\href{https://developersleague.github.io/Etherfunds/}{Documentation} } | {\href{https://everhustle.netlify.app/}{Demo video} }
} 
    \begin{zitemize}
        ...
        \item CRUD features are provided to add new Fundraisers
        \item Managed a group of 3 students, collaborating on building UI and writing smart contracts
    \end{zitemize}
...
HTML, CSS, Bootstrap, JavaScript, ReactJS, SQL, Django, C/C++, Solidity, Git, Java, Markdown
