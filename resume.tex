...
\hskills{Other}: Git, Maven, SonarQube, Veracode, Jenkins, Bitbucket, Gitlab, Docker, Confluence, Infrastructure as code     
% \end{tabular}
% \vspace{0.1cm}
