...
\subtext{Gurgaon, India {\normalsize\normalfont (Remote Internship) }}
    \begin{zitemize}
        \item Built consistent, aesthetic, responsive web \textbf{User interface(UI)} with a performance score of \textbf{90+ on Google Lighthouse} using \textbf{HTML, CSS, Bootstrap, JS, JQuery} \& packages like AOS, sweet-alert, Glightbox. 
...
\subsection*{Etherfunds {\normalsize\normalfont | (Fundraising DAPP) | Solidity, ReactJS, Ethereum Blockchain } |  {\href{https://developersleague.github.io/Etherfunds/}{Documentation} } | {\href{https://youtu.be/UXFDYHBjoxo}{Demo video} }
    ...
    \begin{zitemize}
        ...
        \item Managed a group of 3 students, and build User Interface using \textbf{React.js} library.
