...
\begin{center}
    \begin{minipage}[b]{0.24\textwidth}
            \centering
             Github/ \href{mailto:shyren.more30@gmail.com}{ShyrenMore} \\
...
%%%%%%% ----------------------------------- Role 5 ----------------------------------- %%%%%%%
\subsection*{Front-end Developer {\normalsize\normalfont (Freelance)} \hfill Aug 2021 - Present} 
\subtext{VPSie.inc, Greater New York, USA} 
    \begin{zitemize}
        \item A web-application for verifying KYC that incorporates ML for recognizing \& matching faces of user captured by 10 sec video with documents uploaded like Aadhar card, PAN card, electricity bill. 
        \item Designed \& developed stepper form that included a custom drop zone for uploading documents, a reactive OTP input field and capturing video via utilizing MediaRecorder API of JavaScript.
    \end{zitemize}
...
%%%%%%% ----------------------------------- Role 1 ----------------------------------- %%%%%%%
\subsection*{Sentiment analytics {\normalsize\normalfont (React.js in TypeScript, Python)} \hfill {\href{https://github.com/DevelopersLeague/Brandlytics}{Code} }} 
    \begin{zitemize}
...
\subsection*{EverHustle {\normalsize\normalfont (React.js, HTML, CSS, Axios, React-Query)} \hfill {\href{https://github.com/DevelopersLeague/EverHustle-FrontEnd}{Code} } | {\href{https://everhustle.netlify.app/}{Demo} }} 
    \begin{zitemize}
        ...
        \item Improved user experience by using caching the data using react-query, consumed REST API \& retrieved info
        from third party Algolia API.
