...
\begin{flushleft}
    ...
    \textbf{Data structure and algorithms profiles:} 
...
\subsection*{Barclays Bank PLC \hfill Pune, Maharashtra, India}
...
\begin{zitemize}
    ...
    \item Architected and developed an asynchronous account onboarding feature using SAGA orchestration and the transactional outbox pattern, enabling seamless integration across Treatments, Payments, and Transaction Processing domains.
\end{zitemize}
...
\begin{zitemize}
    ...
    \item Executed the migration of microservice components to Java17 and Spring Boot 3, enchancing system performance and maintainability.
    \item Created alarms, metrics, dashboards and logging framework using AWS CloudWatch for effective production monitoring.
...
\subsection*{VPSie Inc. \hfill New York, United States (Remote)}

\textbf{Software Developer Intern} \hfill \textit{06/2022‑ 07/2022} \\
\vspace{-5pt}
\begin{zitemize}
...
%%%%%%% ----------------------------------- Role 4 ----------------------------------- %%%%%%%
\subsection*{Cyboard School (EdTech Startup) \hfill Delhi, India (Remote)}

\textbf{Software Developer Intern} \hfill \textit{06/2021‑ 09/2021} \\
\vspace{-5pt}
\begin{zitemize}
...
\hskills{Programming Languages, frameworks \& libraries}: Java, Spring Boot, AWS Java SDK, Junit, Mockito, Cucumber, ReactJS

\hskills{AWS tools and services}: AWS SDK, Lambda, Kinesis Data streams (alternative to Kafka), DynamoDB (NoSQL Database), Simple Queue Service (SQS), IAM Roles and Policies, Glue Schema, S3, CloudWatch metrics and alarms, Systems Manager, ECS, Service Catalog, CloudFormation Templates (alternative to Terraform), OpsCenter
